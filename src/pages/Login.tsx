        ...
        <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
          <div className='max-w-[320px] mx-auto py-16'>
            ...
            <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
              ...
              {errors ? <p className='text-lg text-red-400'>{errors}</p> : null}
              <button className='bg-red-600 border border-red-600 hover:bg-transparent duration-300 py-3 my-6 rounded-lg font-bold'>Sign In</button>
              ...
              <p className='py-5'><span className='text-gray-300'>New to Netflix? </span> <span className='text-lg ml-2 hover:text-red-600 duration-200 cursor-pointer underline underline-offset-2'><Link to='/signup'>
              Sign Up
              </Link></span></p>
            </form>
          </div>
